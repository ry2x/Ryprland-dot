...
# location_id = "bca47d1099e762a012b9a139c36f30a0b1e647f69c0c4ac28b537e7ae9c1c200"
...
# status code - try alternative approach using status text
# Let's map common weather phrases to our icon codes
status_lower = status.lower()
if "sunny" in status_lower or "clear" in status_lower:
    if "night" in status_lower:
        status_code = "clearNight"
    else:
        status_code = "sunnyDay"
elif "cloud" in status_lower or "fog" in status_lower:
    if "night" in status_lower:
        status_code = "cloudyFoggyNight"
    else:
        status_code = "cloudyFoggyDay"
elif "rain" in status_lower or "shower" in status_lower or "drizzle" in status_lower:
    if "night" in status_lower:
        status_code = "rainyNight"
    else:
        status_code = "rainyDay"
elif "snow" in status_lower or "ice" in status_lower or "blizzard" in status_lower:
    if "night" in status_lower:
        status_code = "snowyIcyNight"
    else:
        status_code = "snowyIcyDay"
elif "severe" in status_lower or "storm" in status_lower or "thunder" in status_lower:
    status_code = "severe"
else:
    status_code = "default"
